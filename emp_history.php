                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($staff['to_date'] == NULL){
                                            echo "<div class='color-blue'>Đang làm việc</div>";
                                        }else{
                                        ...
                                        <form data-toggle="validator" role="form" action="functionmis.php"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-6">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Số giấy tờ"
                                                           id="id_card_no"
                                            ...
                                            <button type="submit" class="btn btn-lg btn-primary" name="submit">Xác nhận
                                            </button>
        ...
        <div id="changeShift" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">×</button>
                        <h4 class="modal-title">Thay đổi ca làm việc</h4>
                    </div>
                    <div class="modal-body">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <form data-toggle="validator" role="form" action="ajax.php" method="post">
                                            ...
                                            <button type="submit" class="btn btn-lg btn-primary" name="change_shift">Xác nhận</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
