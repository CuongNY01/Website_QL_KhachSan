    ...
    if ($room_no != '') {
        ...
        if (mysqli_num_rows(mysqli_query($connection, $sql)) >= 1) {
            ...
            if ($result) {
                ...
                $response['done'] = false;
                $response['data'] = "Loi co so du lieu";
            }
        }
    } else {
    ...
    if ($customer_result) {
        ...
        if ($booking_result) {
            ...
            if (mysqli_query($connection, $room_stats_sql)) {
                ...
                $response['done'] = false;
                $response['data'] = "Loi co so du lieu in status change";
            }
        } else {
            $response['done'] = false;
            $response['data'] = "Loi co so du lieu booking";
        }
    } else {
        $response['done'] = false;
        $response['data'] = "Loi co so du lieu add customer";
    }
